...
Rails.application.config.sorcery.configure do |config|
  ...
  # config.twitter.callback_url = "http://#{ENV['DOMAIN_NAME']}/oauth/callback?provider=twitter"
  # config.twitter.user_info_mapping = {:email => "screen_name"}

  # config.facebook.key = ENV['FACEBOOK_KEY']
  # config.facebook.secret = ENV['FACEBOOK_SECRET']
  # config.facebook.callback_url = "http://#{ENV['DOMAIN_NAME']}/oauth/callback?provider=facebook"
  ...
  # config.github.callback_url = "http://#{ENV['DOMAIN_NAME']}/oauth/callback?provider=github"
  ...
  # config.google.callback_url = "http://#{ENV['DOMAIN_NAME']}/oauth/callback?provider=google"
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.reset_password_expiration_period = 60 * 60 * 24 # 24 hours


    # hammering protection, how long to wait before allowing another email to be sent.
    # Default: `5 * 60`
    #
    user.reset_password_time_between_emails = 2 * 60
